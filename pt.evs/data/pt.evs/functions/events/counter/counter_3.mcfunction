...
# to .//pt.evs/data/pt.evs/functions/events/counter/counter_3.mcfunction
#
# Generated by Minecraft Script for 1.16
######
title @a actionbar {"text": "PatoEvento en 3 segundos...","color": "green"}
...
schedule function pt.evs:events/counter/counter_2 1s
